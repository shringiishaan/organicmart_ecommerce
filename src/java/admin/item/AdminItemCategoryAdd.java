...
@WebServlet("/AdminItemCategoryAdd")
public class AdminItemCategoryAdd extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	
    public AdminItemCategoryAdd() 
    {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		HttpSession session = request.getSession();
                ...
                else 
                {
                    ...
                    item.addCategory((new ItemDAO()).getCategoryId(request.getParameter("categoryName")));
